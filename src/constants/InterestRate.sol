...
library InterestRate {
    ...
    function calculateInterest(uint256 principal, uint256 interestRatePerSecond, uint256 duration)
        internal
        pure
        returns (uint256)
    {
    ...
    function calculatePrincipalPlusInterest(uint256 principal, uint256 interestRatePerSecond, uint256 duration)
        internal
        pure
        returns (uint256)
    {
        return (principal * rpow(interestRatePerSecond + BASE, duration, BASE)) / BASE;
    }

    function getInterestRateForDuration(uint256 interestRatePerSecond, uint256 duration)
        internal
        pure
        returns (uint256)
    {
